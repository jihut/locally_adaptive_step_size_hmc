...
saveRDS(final_run, "numerical_experiments/sv_model/nuts_biased_progressive_hmc/hamiltonian_error/sv_model_test.RDS")

parallel::stopCluster(init_cluster)

final_run <- 
  readRDS(
    "numerical_experiments/sv_model/nuts_biased_progressive_hmc/hamiltonian_error/sv_model_test.RDS"
  )
...
sink("numerical_experiments/sv_model/nuts_biased_progressive_hmc/hamiltonian_error/sv_model_test.txt")
