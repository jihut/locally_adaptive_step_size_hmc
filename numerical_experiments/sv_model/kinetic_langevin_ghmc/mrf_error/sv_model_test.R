...
final_run <- foreach::foreach(i = 1:n_chains) %dopar% {
  ...
  dir.create("numerical_experiments/sv_model/kinetic_langevin_ghmc/mrf_error/log", showWarnings = F)
  sink(paste0("numerical_experiments/sv_model/kinetic_langevin_ghmc/mrf_error/log/log_nr_", i, ".txt"))
  print("Warmup")
...
saveRDS(final_run, "numerical_experiments/sv_model/kinetic_langevin_ghmc/mrf_error/sv_model_test.RDS")

parallel::stopCluster(init_cluster)

final_run <- 
  readRDS(
    "numerical_experiments/sv_model/kinetic_langevin_ghmc/mrf_error/sv_model_test.RDS"
  )
...
sink("numerical_experiments/sv_model/kinetic_langevin_ghmc/mrf_error/sv_model_test.txt")
print("reversibility")
