...
saveRDS(final_run, "numerical_experiments/funnel_model/biased_progressive_hmc/hamiltonian_error/funnel_model_tuning_test.RDS")
...
sink("numerical_experiments/funnel_model/biased_progressive_hmc/hamiltonian_error/funnel_model_tuning_test.txt")
