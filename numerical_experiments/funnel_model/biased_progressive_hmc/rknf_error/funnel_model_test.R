...
final_run <- foreach::foreach(i = 1:n_chains) %dopar% {
  ...
  dir.create("numerical_experiments/funnel_model/biased_progressive_hmc/rknf_error/log", showWarnings = F)
  sink(paste0("numerical_experiments/funnel_model/biased_progressive_hmc/rknf_error/log/log_nr_", i, ".txt"))
  print("Warmup")
...
saveRDS(final_run, "numerical_experiments/funnel_model/biased_progressive_hmc/rknf_error/funnel_model_test.RDS")
...
sink("numerical_experiments/funnel_model/biased_progressive_hmc/rknf_error/funnel_model_test.txt")
print("dead end")
