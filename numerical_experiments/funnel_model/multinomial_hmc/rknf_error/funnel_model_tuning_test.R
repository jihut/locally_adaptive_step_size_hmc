...
saveRDS(final_run, "numerical_experiments/funnel_model/multinomial_hmc/rknf_error/funnel_model_tuning_test.RDS")
...
sink("numerical_experiments/funnel_model/multinomial_hmc/rknf_error/funnel_model_tuning_test.txt")
