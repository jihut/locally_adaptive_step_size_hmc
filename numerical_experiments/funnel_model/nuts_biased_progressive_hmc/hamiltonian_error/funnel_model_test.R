...
saveRDS(final_run, "numerical_experiments/funnel_model/nuts_biased_progressive_hmc/hamiltonian_error/funnel_model_test.RDS")
...
sink("numerical_experiments/funnel_model/nuts_biased_progressive_hmc/hamiltonian_error/funnel_model_test.txt")
print("dead end")
