...
final_run <- foreach::foreach(i = 1:n_chains) %dopar% {
  ...
  dir.create("numerical_experiments/funnel_model/nuts_biased_progressive_hmc/rknf_error/log", showWarnings = F)
...
saveRDS(final_run, "numerical_experiments/funnel_model/nuts_biased_progressive_hmc/rknf_error/funnel_model_tuning_test.RDS")
...
sink("numerical_experiments/funnel_model/nuts_biased_progressive_hmc/rknf_error/funnel_model_tuning_test.txt")
