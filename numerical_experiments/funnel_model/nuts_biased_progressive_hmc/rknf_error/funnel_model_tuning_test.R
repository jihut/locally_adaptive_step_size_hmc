...
saveRDS(final_run, "numerical_experiments/funnel_model/nuts_biased_progressive_hmc/rknf_error/new_funnel_model_tuning_test.RDS")
...
sink("numerical_experiments/funnel_model/nuts_biased_progressive_hmc/rknf_error/new_funnel_model_tuning_test.txt")
