...
saveRDS(final_run, "numerical_experiments/ar1_model/biased_progressive_hmc/hamiltonian_error/ar1_model_tuning_test.RDS")
...
sink("numerical_experiments/ar1_model/biased_progressive_hmc/hamiltonian_error/ar1_model_tuning_test.txt")
