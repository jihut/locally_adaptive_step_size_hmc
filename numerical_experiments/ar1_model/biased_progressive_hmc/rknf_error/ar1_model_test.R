...
saveRDS(final_run, "numerical_experiments/ar1_model/biased_progressive_hmc/rknf_error/ar1_model_test.RDS")
...
sink("numerical_experiments/ar1_model/biased_progressive_hmc/rknf_error/ar1_model_test.txt")
