...
saveRDS(final_run, "numerical_experiments/ar1_model/nuts_biased_progressive_hmc/rknf_error/ar1_model_tuning_test.RDS")
...
sink("numerical_experiments/ar1_model/nuts_biased_progressive_hmc/rknf_error/ar1_model_tuning_test.txt")
