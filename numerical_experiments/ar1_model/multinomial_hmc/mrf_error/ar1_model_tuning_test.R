...
final_run <- foreach::foreach(i = 1:n_chains) %dopar% {
  ...
  dir.create("numerical_experiments/ar1_model/multinomial_hmc/mrf_error/log", showWarnings = F)
  sink(paste0("numerical_experiments/ar1_model/multinomial_hmc/mrf_error/log/log_nr_", i, ".txt"))
  print("Warmup")
...
saveRDS(final_run, "numerical_experiments/ar1_model/multinomial_hmc/mrf_error/ar1_model_tuning_test.RDS")
...
sink("numerical_experiments/ar1_model/multinomial_hmc/mrf_error/ar1_model_tuning_test.txt")
