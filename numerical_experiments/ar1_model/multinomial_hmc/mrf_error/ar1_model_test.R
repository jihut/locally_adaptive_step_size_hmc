...
saveRDS(final_run, "numerical_experiments/ar1_model/multinomial_hmc/mrf_error/ar1_model_test.RDS")
...
sink("numerical_experiments/ar1_model/multinomial_hmc/mrf_error/ar1_model_test.txt")
