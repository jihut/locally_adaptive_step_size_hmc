...
saveRDS(final_run, "numerical_experiments/ar1_model/multinomial_hmc/rknf_error/ar1_model_tuning_test.RDS")
...
sink("numerical_experiments/ar1_model/multinomial_hmc/rknf_error/ar1_model_tuning_test.txt")
