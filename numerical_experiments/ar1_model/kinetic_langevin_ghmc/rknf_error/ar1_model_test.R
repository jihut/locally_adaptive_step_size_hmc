...
final_run <- foreach::foreach(i = 1:n_chains) %dopar% {
  ...
  dir.create("numerical_experiments/ar1_model/kinetic_langevin_ghmc/rknf_error/log", showWarnings = F)
...
saveRDS(final_run, "numerical_experiments/ar1_model/kinetic_langevin_ghmc/rknf_error/ar1_model_test.RDS")
